...
const float servoConfig[6][13] = {
    ...
    { j2_step_pin, j2_dir_pin, j2_hs_pin, 300 * DEG_TO_RAD,  j2_encA_pin, j2_encB_pin,  -45.00 * DEG_TO_RAD,  90.00 * DEG_TO_RAD, 0, -1, -1, 40000 * 1.3, 51200 * 1.3},
    ...
    { j5_step_pin, j5_dir_pin, j5_hs_pin, 300 * DEG_TO_RAD,  j5_encA_pin, j5_encB_pin, -140.00 * DEG_TO_RAD,  15.00 * DEG_TO_RAD, 0, -1, -1, 5000, 3197},
    { j6_step_pin, j6_dir_pin, j6_hs_pin, 300 * DEG_TO_RAD,  j6_encA_pin, j6_encB_pin,  -90.00 * DEG_TO_RAD,  60.00 * DEG_TO_RAD, 0, 1, 1, 14500, 18549}
};
