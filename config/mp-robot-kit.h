...
const float servoConfig[6][12] = {
    ...
    { j4_step_pin, j4_dir_pin, j4_hs_pin, 300 * DEG_TO_RAD,  j4_encA_pin, j4_encB_pin,  -90.00 * DEG_TO_RAD,  90.00 * DEG_TO_RAD, 0, -1, 43948 * 1.42, 56258 * 1.42},
    { j5_step_pin, j5_dir_pin, j5_hs_pin, 300 * DEG_TO_RAD,  j5_encA_pin, j5_encB_pin, -140.00 * DEG_TO_RAD,  15.00 * DEG_TO_RAD, 0, 1, 1, 1},
